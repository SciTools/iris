...
.. dropdown:: |icon_report| v3.0.0 Release Highlights
   :animate: fade-in
   :class-body: bg-light
   :open:
...
.. dropdown:: |icon_alert| v3.0.1 Patches
   :animate: fade-in
   :class-body: bg-light
...
.. dropdown:: |icon_alert| v3.0.2 Patches
   :animate: fade-in
   :class-body: bg-light
...
.. dropdown:: |icon_alert| v3.0.3 Patches
   :animate: fade-in
   :class-body: bg-light
...
.. dropdown:: |icon_alert| v3.0.4 Patches
   :animate: fade-in
   :class-body: bg-light
