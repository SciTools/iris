...
|iris_version| |build_date| [release candidate]
***********************************************
...
.. dropdown:: :opticon:`report` |iris_version| Release Highlights
   ...
   * We have **archived older Iris documentation** - everything before
     ``v3.0.0`` - so older versions will no longer appear in search engines. If
     you need this older documentation: please see :ref:`iris_support`.
