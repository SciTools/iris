...
#. `@trexfeathers`_ added a new top-level :doc:`/user_manual/section_indexes/community` section,
...
#. The **Iris community**, with help from the **Xarray community**, produced
   the :doc:`../user_manual/explanation/iris_xarray` page, highlighting the similarities and
