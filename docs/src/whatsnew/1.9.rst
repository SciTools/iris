...
* Added several new helper functions for file-save customisation,
  (see also : :doc:`Saving Iris Cubes </user_manual/tutorial/saving_iris_cubes>`):
...
* A chapter on :doc:`saving iris cubes </user_manual/tutorial/saving_iris_cubes>` has been
  added to the :doc:`User Guide </user_manual/section_indexes/userguide>`.
