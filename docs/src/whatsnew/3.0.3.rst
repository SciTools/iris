...
.. dropdown:: :opticon:`report` v3.0.0 Release Highlights
   ...
   * Our :ref:`documentation <whatsnew 3.0.3 docs>` has been refreshed,
   ...
   * Also, this is a major release of Iris, so please be aware of the
     :ref:`incompatible changes <whatsnew 3.0.3 changes>` and
     :ref:`deprecations <whatsnew 3.0.3 deprecations>`.
