...
.. admonition:: Dask Integration
  ...
  *lazy evaluation* within Iris has been replaced with `Dask`_.
  ...
  </user_manual/explanation/real_and_lazy_data>`.
...
* A new UserGuide chapter on :doc:`Real and Lazy Data
  </user_manual/explanation/real_and_lazy_data>` has been added, and referenced from key
  points in the :doc:`User Guide </user_manual/section_indexes/userguide>` .
