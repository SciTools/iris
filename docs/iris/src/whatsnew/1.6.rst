...
The modules :mod:`iris.fileformats.um_cf_map` and :mod:`iris.fileformats.grib._grib_cf_map` which provide the translations for UM STASH and Field codes and GRIB parameter codes to and from CF standard names and units of measure have been updated.
