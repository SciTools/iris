...
.. dropdown:: :opticon:`report` Release Highlights
   ...
   * It's now easier than ever to :ref:`install Iris <installing_iris>`
     as a user or a developer, and the developers guide walks you though
     how you can :ref:`get involved <development_where_to_start>` and
     contribute to Iris,
   ...
   * Cube maths has been significantly improved with regards to extended
