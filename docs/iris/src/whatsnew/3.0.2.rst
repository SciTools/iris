...
.. dropdown:: :opticon:`alert` v3.0.2 Patches
   ...
   #. `@pp-mo`_ reverted a change made previously in (:pull:`3659`) to PPDataProxy.__getitem__.
       The check for empty slicings is no longer needed since (:pull:`4135`) was added.
      (:pull:`4141`)
...
.. dropdown:: :opticon:`report` v3.0.0 Release Highlights
   ...
   * Our :ref:`documentation <whatsnew 3.0.2 docs>` has been refreshed,
   ...
   * Also, this is a major release of Iris, so please be aware of the
     :ref:`incompatible changes <whatsnew 3.0.2 changes>` and
     :ref:`deprecations <whatsnew 3.0.2 deprecations>`.
