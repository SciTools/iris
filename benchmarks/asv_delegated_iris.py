...
"""Iris-specific adaptation of :mod:`asv_delegated`."""
...
class DelegatedIris(Delegated):
    """Specialism of :class:`Delegated` for benchmarking Iris."""

    tool_name = "delegated-iris"

    def _prep_env_override(self, env_parent_dir: Path) -> Path:
        """Iris-specific environment preparation.
