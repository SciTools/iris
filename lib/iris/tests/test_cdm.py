...
class TestCubeStringRepresentations(IrisDotTest):
    def setUp(self):
        ...
        unicode_str = six.unichr(40960) + "abcd" + six.unichr(1972)
    ...
    def test_basic_0d_cube(self):
        ...
        self.assertString(
            six.text_type(self.cube_2d[0, 0]),
    ...
    def test_adjusted_default_encoding(self):
        ...
        with self.unicode_encoding_change("utf-8"):
            self.assertString(
                ...
                ("cdm", "str_repr", "unicode_attribute.__str__.utf8.txt"),
            )
        with self.unicode_encoding_change("ascii"):
            self.assertString(
                str(self.unicode_cube),
                ("cdm", "str_repr", "unicode_attribute.__str__.ascii.txt"),
            )
