...
class TestGrib2LoadPhenomenon(TestGribSimple):
    ...
    def test_grib2_unknownparam(self):
        ...
        result = gpt.grib2_phenom_to_cf_info(grib.discipline,
                                             grib.parameterCategory,
                                             grib.parameterNumber)
    ...
    def test_grib2_known_standard_params(self):
        ...
        full_set = [
            ...
            (0, 6, 1, None,
             "cloud_area_fraction_assuming_maximum_random_overlap", "1"),
        ...
        for (discipline, category, number,
            ...
            result = gpt.grib2_phenom_to_cf_info(discipline,
                                                 category,
                                                 number)
