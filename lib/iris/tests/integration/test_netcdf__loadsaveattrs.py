...
# Let's simply exclude "ukmo__process_flags", as the required value structure is weird
#  and doesn't fit our general testing structure.
_LOCAL_TEST_ATTRS = [x for x in _LOCAL_TEST_ATTRS if x != "ukmo__process_flags"]
