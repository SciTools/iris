...
#        self.assertArrayAllClose(y_bds, np.array([[[-10., 10, 30, 10]]]))
    ...
    def __notatest_single_cell_equatorial(self):
    ...
    #                                              central_latitude=30.))
            ...
            for lat in np.linspace(y_0, y_n, ny):
                cube = self._singlecell_diamond_cube(x0=lon0, y0=lat, dy=dy)
