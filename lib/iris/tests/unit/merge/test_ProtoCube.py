...
class Test_register__match(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
        return []
...
@tests._test_timings_class_decorator
class Test_register__standard_name(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
...
@tests._test_timings_class_decorator
class Test_register__long_name(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
...
@tests._test_timings_class_decorator
class Test_register__var_name(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
...
@tests._test_timings_class_decorator
class Test_register__units(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
...
@tests._test_timings_class_decorator
class Test_register__cell_method(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
...
@tests._test_timings_class_decorator
class Test_register__data_shape(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
...
@tests._test_timings_class_decorator
class Test_register__data_dtype(Mixin_register, tests._IrisTest_nometa):
    @property
    def fragments(self):
