...
class Mixin__ukmo_attributes(Mixin__nc_load_actions):
...
class Test__ukmo_attributes__withpyke(Mixin__ukmo_attributes, tests.IrisTest):
    use_pyke = True


class Mixin__labels_cellmeasures_ancils(Mixin__nc_load_actions):
...
class Test__labels_cellmeasures_ancils__withpyke(
    Mixin__labels_cellmeasures_ancils, tests.IrisTest
):
    use_pyke = True
