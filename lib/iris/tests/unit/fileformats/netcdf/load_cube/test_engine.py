...
class Test_Engine(tests.IrisTest):
    ...
    def test_add_case_specific_fact__newname(self):
        ...
        engine = self.nonempty_engine
        engine.add_case_specific_fact("junkname", "new_fact", ("a1", "a2"))
    ...
    def test_add_case_specific_fact__existingname(self):
        ...
        engine.add_case_specific_fact("junkname", name, ("yetanother",))
        self.assertEqual(
    ...
    def test_add_case_specific_fact__emptyargs(self):
        ...
        engine = self.empty_engine
        engine.add_case_specific_fact("junkname", "new_fact", ())
    ...
    def test_add_fact(self):
        ...
        self.assertEqual(
            ...
            [mock.call(kb_name="<n/a>", fact_name="extra", fact_arglist=())],
        )
