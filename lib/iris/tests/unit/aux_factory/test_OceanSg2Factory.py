...
class Test___init__(tests.IrisTest):
    ...
    def test_insufficient_coordinates(self):
        with self.assertRaises(ValueError):
            OceanSg2Factory()
        with self.assertRaises(ValueError):
            OceanSg2Factory(s=None, c=self.c, eta=self.eta,
                            depth=self.depth, depth_c=self.depth_c)
        with self.assertRaises(ValueError):
            OceanSg2Factory(s=self.s, c=None, eta=self.eta,
                            depth=self.depth, depth_c=self.depth_c)
        with self.assertRaises(ValueError):
            OceanSg2Factory(s=self.s, c=self.c, eta=None,
                            depth=self.depth, depth_c=self.depth_c)
        with self.assertRaises(ValueError):
            OceanSg2Factory(s=self.s, c=self.c, eta=self.eta,
