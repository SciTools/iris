...
"""Unit tests for the :func:`iris.ugrid.load.load_mesh` function."""

# Import iris.tests first so that some things can be initialised before
# importing anything else.
import iris.tests as tests  # isort:skip

from iris.ugrid.load import load_mesh
...
class Tests(tests.IrisTest):
    ...
    def setUp(self):
        self.load_meshes_mock = self.patch("iris.ugrid.load.load_meshes")
