...
class StandardReportWithExclusions(pep8.StandardReport):
    ...
    def get_file_results(self):
        ...
        return super(StandardReportWithExclusions, self).get_file_results()
...
class TestCodeFormat(tests.IrisTest):
    def test_pep8_conformance(self):
        ...
        pep8style = pep8.StyleGuide(
            quiet=False, reporter=StandardReportWithExclusions
        )
        ...
        if reporter is StandardReportWithExclusions:
            ...
            if unexpectedly_good:
                self.fail(
                    "Some exclude patterns were unnecessary as the "
