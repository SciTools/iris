...
STASH_TO_CF = {
    ...
    'm01s04i205': CFName('mass_fraction_of_cloud_ice_in_air', None, '1'),
    'm01s04i206': CFName('mass_fraction_of_cloud_liquid_water_in_air', None, '1'),
    ...
    'm04s06i001': CFName('sea_surface_wave_significant_height', None, 'm'),
    }
