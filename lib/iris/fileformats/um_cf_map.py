...
STASH_TO_CF = {
    ...
    'm01s00i058': CFName(None, 'tendency_of_atmosphere_mass_content_of_sulfur_dioxide_due_to_low_level_emission_expressed_as_sulfur', 'kg/m2/s'),
    'm01s00i059': CFName(None, 'tendency_of_atmosphere_mass_content_of_dimethyl_sulfide_due_to_emission_expressed_as_sulfur', 'kg/m2/s'),
    'm01s00i060': CFName('mass_fraction_of_ozone_in_air', None, '1'),
    'm01s00i095': CFName(None, 'Snow amount on sea ice', 'kg/m^2'),
    'm01s00i101': CFName(None, 'mass_fraction_of_sulfur_dioxide_in_air_expressed_as_sulfur', 'kg/kg'),
    'm01s00i102': CFName(None, 'mass_fraction_of_dimethyl_sulfide_in_air_expressed_as_sulfur', 'kg/kg'),
    'm01s00i103': CFName(None, 'mass_fraction_of_aitken_mode_sulfate_dry_aerosol_in_air_expressed_as_sulfur', 'kg/kg'),
    'm01s00i104': CFName(None, 'mass_fraction_of_accumulation_mode_sulfate_dry_aerosol_in_air_expressed_as_sulfur', 'kg/kg'),
    'm01s00i105': CFName(None, 'mass_fraction_of_dissolved_sulfate_dry_aerosol_in_air_expressed_as_sulfur', 'kg/kg'),
    'm01s00i106': CFName(None, 'mass_fraction_of_hydrogen_peroxide_in_air', 'kg/kg'),
    'm01s00i107': CFName(None, 'mass_fraction_of_ammonia_in_air_expressed_as_nitrogen', 'kg/kg'),
    ...
    'm01s00i117': CFName(None, 'mass_fraction_of_accumulation_mode_nitrate_dry_aerosol_in_air_expressed_as_nitrogen', 'kg/kg'),
    'm01s00i118': CFName(None, 'mass_fraction_of_dissolved_nitrate_dry_aerosol_in_air_expressed_as_nitrogen', 'kg/kg'),
    'm01s00i121': CFName(None, 'tendency_of_atmosphere_mass_content_of_sulfur_dioxide_due_to_volcanic_emission_expressed_as_sulfur', 'kg/kg'),
    'm01s00i122': CFName(None, 'molecular_concentration_of_hydroxyl_radical_in_air', 'molecules/cm3'),
    'm01s00i123': CFName(None, 'molecular_concentration_of_hydroperoxyl_radical_in_air', 'molecules/cm3'),
    'm01s00i124': CFName(None, 'mass_fraction_of_hydrogen_peroxide_in_air', 'kg/kg'),
    'm01s00i125': CFName(None, 'mass_fraction_of_ozone_in_air ', 'kg/kg'),
    'm01s00i126': CFName(None, 'tendency_of_atmosphere_mass_content_of_sulfur_dioxide_due_to_high_level_emission_expressed_as_sulfur', 'kg/m2/s'),
    'm01s00i127': CFName(None, 'tendency_of_atmosphere_mass_content_of_ammonia_due_to_emission_expressed_as_nitrogen', 'kg/m2/s'),
    ...
    'm01s00i132': CFName(None, 'mole_concentration_of_dimethyl_sulfide_in_sea_water', 'nanomole/l'),
    ...
    'm01s00i266': CFName(None, 'Cloud fraction in a layer', '1'),
    ...
    'm01s00i415': CFName(None, 'sea_ice_surface_temperature', 'K'),
    'm01s00i416': CFName(None, 'Snow thickness on sea ice', 'm'),
    'm01s00i418': CFName(None, 'volume_fraction_of_clay_in_soil', 'm3/m3'),
    'm01s00i419': CFName(None, 'volume_fraction_of_silt_in_soil', 'm3/m3'),
    'm01s00i420': CFName(None, 'volume_fraction_of_sand_in_soil', 'm3/m3'),
    'm01s00i421': CFName(None, 'mass_fraction_of_soil_particles_in_division1', 'kg/kg'),
    'm01s00i422': CFName(None, 'mass_fraction_of_soil_particles_in_division2', 'kg/kg'),
    'm01s00i423': CFName(None, 'mass_fraction_of_soil_particles_in_division3', 'kg/kg'),
    'm01s00i424': CFName(None, 'mass_fraction_of_soil_particles_in_division4', 'kg/kg'),
    'm01s00i425': CFName(None, 'mass_fraction_of_soil_particles_in_division5', 'kg/kg'),
    'm01s00i426': CFName(None, 'mass_fraction_of_soil_particles_in_division6', 'kg/kg'),
    'm01s00i431': CFName(None, 'mass_fraction_of_dust_division_1_dry_aerosol_in_air', 'kg/kg'),
    'm01s00i432': CFName(None, 'mass_fraction_of_dust_division_2_dry_aerosol_in_air', 'kg/kg'),
    'm01s00i433': CFName(None, 'mass_fraction_of_dust_division_3_dry_aerosol_in_air', 'kg/kg'),
    'm01s00i434': CFName(None, 'mass_fraction_of_dust_division_4_dry_aerosol_in_air', 'kg/kg'),
    'm01s00i435': CFName(None, 'mass_fraction_of_dust_division_5_dry_aerosol_in_air', 'kg/kg'),
    'm01s00i436': CFName(None, 'mass_fraction_of_dust_division_6_dry_aerosol_in_air', 'kg/kg'),
    ...
    'm01s02i284': CFName(None, 'atmosphere_absorption_optical_thickness_due_to_sulfate_ambient_aerosol', '1'),
    'm01s02i285': CFName(None, 'atmosphere_absorption_optical_thickness_due_to_dust_dry_aerosol', '1'),
    'm01s02i286': CFName(None, 'atmosphere_absorption_optical_thickness_due_to_seasalt_ambient_aerosol', '1'),
    'm01s02i287': CFName(None, 'Optical depth due to soot', '1'),
    'm01s02i288': CFName(None, 'Optical depth due to biomass', '1'),
    'm01s02i289': CFName(None, 'Optical depth due to biogenic', '1'),
    'm01s02i295': CFName(None, 'Fossil fuel organic carbon optical depth', '1'),
    'm01s02i422': CFName(None, 'Dust optical depth from prognostic tendency', '1'),
    ...
    'm01s03i231': CFName(None, 'water_sublimation_flux', 'kg/m^2/time step'),
    ...
    'm01s03i263': CFName(None, 'plant_respiration_carbon_flux', 'kg/m^2/s'),
    'm01s03i293': CFName(None, 'soil_respiration_carbon_flux', 'kg/m^2/s'),
    ...
    'm01s08i233': CFName(None, 'canopy_throughfall_flux', 'kg/m^2/s'),
