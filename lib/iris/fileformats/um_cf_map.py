...
STASH_TO_CF = {
    ...
    'm01s02i284': CFName('atmosphere_absorption_optical_thickness_due_to_sulfate_ambient_aerosol', None, '1'),
    'm01s02i285': CFName(None, 'atmosphere_absorption_optical_thickness_due_to_dust_dry_aerosol', '1'),
    'm01s02i286': CFName('atmosphere_absorption_optical_thickness_due_to_seasalt_ambient_aerosol', None, '1'),
