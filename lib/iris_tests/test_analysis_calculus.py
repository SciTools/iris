...
def build_cube(data, spherical=False):
    ...
    if spherical:
        ...
        cube.add_dim_coord(DimCoord(numpy.arange(nx, dtype=numpy.float32) * 2.21 + 2, long_name='x', units='meters'), dimx) 
        cube.add_dim_coord(DimCoord(numpy.arange(ny, dtype=numpy.float32) * 25 -50, long_name='y', units='meters'), dimy)
